export default function FinancialsPage() {
    return (
      <div className="space-y-10">
        <h1 className="text-2xl font-bold mb-6">FCEPL Financials</h1>
  
        {/* Financial Summary */}
        <section>
          <h2 className="text-xl font-semibold mb-2">Key Financials (Annual)</h2>
        ...
        <section>
          ...
          <table className="w-full table-auto border border-gray-300 text-sm">
            ...
            <tbody>
              <tr>
                <td className="border px-4 py-2">Gross Profit Margin (%)</td>
              ...
              <tr>
                <td className="border px-4 py-2">Net Profit Margin (%)</td>
              ...
              <tr>
                <td className="border px-4 py-2">EPS Growth (%)</td>
                <td className="border px-4 py-2">45.69</td>
                <td className="text-red-500">-38.82</td>
                <td>37.02</td>
                <td>921.74</td>
              </tr>
              <tr>
                <td className="border px-4 py-2">PEG</td>
                <td className="border px-4 py-2">0.68</td>
                <td className="text-red-500">-1.07</td>
                <td>0.55</td>
                <td>0.04</td>
              </tr>
            </tbody>
        ...
        <section>
          ...
          <table className="w-full table-auto border border-gray-300 text-sm">
            ...
            <tbody>
              ...
              ].map(([type, period, posted], i) => (
                <tr key={i}>
                  <td className="border px-4 py-2">{type}</td>
                  <td className="border px-4 py-2">{period}</td>
                  <td className="border px-4 py-2">{posted}</td>
                </tr>
              ))}
            </tbody>
          </table>
